...
export class ForgetComponent {
  _forget: Forget = new Forget();
  forgetForm: FormGroup;
  loadingIcon = new AppIcon({id:5,icon:"faSpinner",size:"lg",spin:false,className:""});
  forgetLink = new AppLink({id:1,name:"Forget password",className:"text-dark text-decoration-none d-flex flex-column align-items-center",link:"forget",icon:{id:1,icon:"faUser",size:"2x",spin:false,className:""}});
