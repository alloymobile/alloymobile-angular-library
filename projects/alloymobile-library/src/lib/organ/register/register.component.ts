...
export class RegisterComponent {
  ...
  registerLink = new AppLink({id:1,name:"Sign up",className:"text-dark text-decoration-none d-flex flex-column align-items-center",link:"register",icon:{id:1,icon:"faUser",size:"2x",spin:false,className:""}});
